...
export default function ChallengeTrailsPanel({ minMiles = 10, minRating = 4, limit = 12 }) {
  const {
    data: apiData = [],
    isLoading,
    isError,
  ...
  const trails = (apiData ?? []).slice(0, limit);
  ...
  return (
    <section className="space-y-4">
      <h2 className="text-2xl font-bold text-gray-800 border-b pb-2">🏔️ Challenge Trails</h2>
          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                <span className="inline-block text-green-600 font-medium">{miles} mi</span> · <span className="text-yellow-600 font-medium">{rating} ★</span>
              </p>
            </Link>
          );
        })}
